...
namespace SmartMeter.Hubs
{
    public interface IMeterStore
    {
        ...
        bool TryGetByConnectionId(string connectionId, out Meter? meter);
    ...
    public class MeterStore : IMeterStore
    {
        ...
        public bool TryGetByConnectionId(string connectionId, out Meter? meter) =>
            ByConnectionId.TryGetValue(connectionId, out meter);
